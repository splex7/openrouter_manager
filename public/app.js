...
function openCredentialLimit(credentialId) {
  ...
  $("#credentialLimitSummary").textContent = `${credential.subjectName || "조 공용 키"} · ${credential.keyLabel} · 현재 ${money(credential.limitUsd)} (${resetLabel(credential.limitReset)})`;
